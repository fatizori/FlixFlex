...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-[#D3A748] text-sm font-medium leading-5 text-[#D3A748] focus:outline-none focus:border-[#D3A748] focus:text-[#D3A748] transition'
